    ...
    <section class="_flex _flex-col _gap-[inherit]">
      ...
      >
        ...
        <ul class="_space-y-2">
          ...
          <!-- (add mini-app to farcaster button) - only show if client supports addMiniApp -->
          <template v-if="isFarcaster && !isFarcaster.client.added && supportsAddMiniApp">
...
const supportsAddMiniApp = computed(() => auth.supportsAddMiniApp)
